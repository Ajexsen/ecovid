...
const line_param_air = {
    ...
    data_files: ["air_2017.csv", "air_2018.csv", "air_2019.csv", "air_2020.csv", "air_2021.csv"],
    line_legends: ["2017", "2018", "2019", "2020", "2021"],
...
const line_param_rail = {
    ...
    data_files: ["rail_2017.csv", "rail_2018.csv", "rail_2019.csv", "rail_2020.csv", "rail_2021.csv"],
    line_legends: ["2017", "2018", "2019", "2020", "2021"],
    line_colors: line_colors,
    x: "Monat",
    y: "Rail transport",
...
const line_param_road = {
    ...
    data_files: ["road_2017.csv", "road_2018.csv", "road_2019.csv", "road_2020.csv", "road_2021.csv"],
    line_legends: ["2017", "2018", "2019", "2020", "2021"],
    line_colors: line_colors,
    x: "Monat",
    y: "Road transport",
...
const line_param_water = {
    ...
    data_files: ["water_2017.csv", "water_2018.csv", "water_2019.csv", "water_2020.csv", "water_2021.csv"],
    line_legends: ["2017", "2018", "2019", "2020", "2021"],
    line_colors: line_colors,
    x: "Monat",
...
const line_param_import = {
    ...
    data_files: ["im_2017.csv", "im_2018.csv", "im_2019.csv", "im_2020.csv", "im_2021.csv"],
...
const line_param_export = {
    ...
    data_files: ["ex_2017.csv", "ex_2018.csv", "ex_2019.csv", "ex_2020.csv", "ex_2021.csv"],
